        ...
        <div className="flex justify-between mt-4">
          <div className="flex gap-2">
            ...
            <span
              ...
              className="flex items-center justify-center transition ease-out duration-300 hover:bg-blue-500 hover:text-white bg-blue-100 w-8 h-8 rounded-full text-blue-400 cursor-pointer">
            ...
            <span className="flex items-center justify-center transition ease-out duration-300 hover:bg-blue-500 hover:text-white bg-blue-100 w-8 h-8 rounded-full text-blue-400 cursor-pointer">
              <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="css-i6dzq1">
