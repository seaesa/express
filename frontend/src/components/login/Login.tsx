      ...
      <div className="h-screen bg-gray-50 flex flex-col justify-center items-center">
        <div className="rounded-lg shadow-lg relative bg-white w-80 pb-8 flex items-center flex-col mb-3">
          ...
          <Form className='w-64 flex flex-col'>
            <Form.Item initialValue={username} name='username' rules={[{ required: true, whitespace: true }]} >
              <Input
                value={username}
                onChange={e => setUsername(e.target.value)}
                placeholder='username' name='username' />
            </Form.Item>
            <Form.Item initialValue={password} name='password' rules={[{ required: true, whitespace: true }]} >
              <Input.Password
                value={password}
